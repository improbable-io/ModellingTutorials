...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=1.25]{media/esahubble.png}}} % Image background
\centering
\vspace*{5cm}
...
\input{01_recipe}
\input{02_modelling_steps}
\input{03_science_sdk}
\input{04_solar_system}
